...
def draw_confidence_intervals_pairs(idf,confidence_level=0.95,point_marker='x',point_color='red',
                             mean_line_color='red',
                              box_alpha=0.2,box_color='blue',box_width=1,
                              column_separation=2,
                              y_resolution=0.5,max_y=None,
...
def draw_confidence_intervals_by_colors(idf,confidence_level=0.95,point_marker='x',point_color='red',
                             mean_line_color='red',
                              box_alpha=0.2,box_color='blue',box_width=1,
                              column_separation=2,
                              y_resolution=0.5,max_y=None,
                             ...
                             title='',xlabel='',ylabel='',
                              show=True,
                             save=None,save_kargs={'transparent':False},colors=['blue','red','green']):
    """
    idf: A dataframe that has the samples as rows and the columns are the variables to draw
    For save_kargs:
    #https://matplotlib.org/3.1.1/api/_as_gen/matplotlib.pyplot.savefig.html
